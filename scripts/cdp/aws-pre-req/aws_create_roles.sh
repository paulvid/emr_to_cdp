...
cat $1/scripts/cdp/aws-pre-req/aws-ec2-and-idbroker-role-trust-policy.json |  sed s/AWS_ACCOUNT_ID/$AWS_ACCOUNT_ID/g | sed s/IDBROKER_ROLE/$IDBROKER_ROLE/g  > $1/scripts/cdp/aws-pre-req/tmp
aws iam create-role --role-name $2-log-role --assume-role-policy-document file://$1/scripts/cdp/aws-pre-req/tmp
sleep $sleep_duration 
